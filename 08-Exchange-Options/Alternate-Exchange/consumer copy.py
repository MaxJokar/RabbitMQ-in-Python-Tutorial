...
channel.basic_consume(queue='altexchangequeue', 
        on_message_callback=alt_queue_on_message_received)

channel.queue_declare(queue='mainexchangequeue')
#  the message is routbale via exchange should never have to go to Altexchange
channel.queue_bind('mainexchangequeue', 'mainexchange', 'test') # test is a routing key that declared in the producer
channel.basic_consume(queue='mainexchangequeue', 
